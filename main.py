...
def main():
    ...
    <h2 style = "color:black;text-align:center;"> Nankling86 Car Price Prediction Web App </h2> 
    </div>
    """
    
    model = xgb.XGBRegressor()
    model.load_model("C:/Users/Nankl/Desktop/CODE PLATEAU 6.0/xgb_model.json")
